<template>
    <div class="main--section main--section--characters">
        ...
        <div class="main--section--characters--body">
            <img class="main--section--characters--body--arrow" src="../../assets/icons/chevron-left.svg" alt="chevron" />
            ...
            <img class="main--section--characters--body--arrow main--section--characters--body--arrow--right" src="../../assets/icons/chevron-left.svg" alt="chevron" />
        </div>
    </div>
</template>
