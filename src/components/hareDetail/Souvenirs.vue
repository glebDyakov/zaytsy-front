  ...
  <div class="custom-container">
    <div class="main--section main--section--characters">
      ...
      <div class="main--section--characters--body relative">
        <div class="absolute top-[30%] left-[-40px]">
          <img class="cursor-pointer" src="@/assets/icons/chevron-left.svg" alt="chevron" />
        </div>
        ...
        <div class="absolute top-[30%] right-[-40px]">
          <img class="cursor-pointer" src="@/assets/icons/chevron-right.svg" alt="chevron" />
        </div>
      </div>
    </div>
  </div>
